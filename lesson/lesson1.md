...
- [Programming languages TIOBE Index](http://www.tiobe.com/index.php/items/paperinfo/tpci/index.html)
...
- При этом храните все резюме в начале `ru.javawebinar.basejava.storage` (без дырок в виде `null`), чтобы не перебирать каждый раз все 10000 элементов
```
Схема хранения резюме в ru.javawebinar.basejava.storage (от 0 до size - 1 элементов null нет):
