...
public class TestData {
	...
	static {
		...
		R1.setSection(SectionType.OBJECTIVE, new PlainText("Objective1"));
		R1.setSection(SectionType.PERSONAL, new PlainText("Personal data"));
		R1.setSection(SectionType.ACHIEVEMENT, new StringListText("Achievement11", "Achievement12", "Achievement13"));
		R1.setSection(SectionType.QUALIFICATIONS, new StringListText(Collections.emptyList()));
		...
		R2.setSection(SectionType.OBJECTIVE, new PlainText("Objective1"));
		R2.setSection(SectionType.QUALIFICATIONS, new StringListText("Q1", "Q2", "Q3"));
